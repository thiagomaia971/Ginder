            ...
            modelBuilder.Entity("Ginder.Domain.Entities.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 6, 20, 15, 39, 1, 752, DateTimeKind.Unspecified).AddTicks(6992), new TimeSpan(0, -3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 6, 20, 15, 39, 1, 752, DateTimeKind.Unspecified).AddTicks(7100), new TimeSpan(0, -3, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 6, 20, 15, 39, 1, 752, DateTimeKind.Unspecified).AddTicks(7108), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("Ginder.Domain.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 6, 20, 15, 39, 1, 804, DateTimeKind.Unspecified).AddTicks(356), new TimeSpan(0, -3, 0, 0, 0)),
                            Idade = 20,
            ...
            modelBuilder.Entity("Ginder.Domain.Entities.PlayerGame", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 6, 20, 15, 39, 1, 804, DateTimeKind.Unspecified).AddTicks(7542), new TimeSpan(0, -3, 0, 0, 0)),
            ...
            modelBuilder.Entity("Ginder.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2020, 6, 20, 15, 39, 1, 805, DateTimeKind.Unspecified).AddTicks(3277), new TimeSpan(0, -3, 0, 0, 0)),
                            Login = "admin",
                            Password = "123",
                            PlayerId = new Guid("c8413c17-63e7-491a-9eae-0489737e19ff")
                        });
